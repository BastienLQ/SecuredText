...
import org.smssecure.smssecure.jobs.PushReceiveJob;
...
import org.smssecure.textsecure.api.TextSecureMessagePipe;
...
public class MessageRetrievalService extends Service implements Runnable, InjectableType, RequirementListener {
  ...
  private synchronized boolean isConnectionNecessary() {
    ...
    return SMSSecurePreferences.isWebsocketRegistered(this) &&
